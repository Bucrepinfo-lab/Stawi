  ...
  return (
    <main style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px' }}>
      ...
      <section style={{ padding: '60px 0 40px', maxWidth: 760 }}>
        ...
        <h1
          className="display"
          style={{ fontWeight: 600, fontSize: 'clamp(36px,6vw,64px)', lineHeight: 1.03 }}
        >
          Save together.{' '}
        ...
        <p style={{ marginTop: 18, fontSize: 18, color: 'var(--ink-2)' }}>
          ...
          real books — table banking, business matching, and QuickBooks-grade accounting
          in one platform. Mobile-first and M-Pesa-native.
        </p>
        <div style={{ display: 'flex', gap: 12, marginTop: 28, flexWrap: 'wrap' }}>
          {['① Table Banking', '② Business Matching', '③ Accounting & Admin'].map((p) => (
            <span
              key={p}
              style={{
                fontSize: 13,
